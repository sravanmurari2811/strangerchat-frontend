        ...
        <main className="min-h-screen w-full flex flex-col items-center p-4 md:p-6 relative overflow-y-auto overflow-x-hidden font-['Plus_Jakarta_Sans'] perspective-2000 scroll-smooth" role="main">
            ...
            <div className="max-w-5xl w-full flex flex-col items-center z-10 preserve-3d py-6 md:py-10">
                ...
                <header className="text-center mb-8 md:mb-12 space-y-3 animate-reveal">
                    ...
                    <p className="text-slate-400 font-medium max-w-lg mx-auto text-[13px] md:text-sm px-4 opacity-90 leading-relaxed">
                    ...
                    >
                        <div className="space-y-5">
                            <div className="flex items-center gap-3 mb-1">
                                ...
                                <h2 className="text-base md:text-lg font-black text-white tracking-tight">Identity Setup</h2>
                            </div>

                            <div className="space-y-4">
                                <div className="space-y-1.5">
                                    <label htmlFor="nickname" className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 ml-1">Your Alias</label>
                                    <div className="relative group">
                                        <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-blue-500 transition-colors" size={16} aria-hidden="true" />
                                        <input
                                            id="nickname"
                                            type="text"
                                            value={nickname}
                                            ...
                                            className="w-full bg-black/40 border border-white/10 rounded-xl py-3.5 pl-12 pr-5 focus:outline-none focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/5 transition-all font-bold text-slate-100 text-[13px] shadow-inner"
                                            autoComplete="off"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="space-y-1.5">
                                            <label htmlFor="age" className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 ml-1">Age Verification</label>
                                            <input
                                                id="age"
                                                type="number"
                                                required
                                                ...
                                                placeholder="Age (18+)"
                                                className={`w-full bg-black/40 border ${error ? 'border-red-500/50 ring-4 ring-red-500/5' : 'border-white/10'} rounded-xl py-3.5 px-5 focus:outline-none focus:border-blue-500/50 transition-all font-black text-center text-sm shadow-inner`}
                                            />
                                        </div>

                                        <div className="space-y-1.5">
                                            <label className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 ml-1">Gender Identity</label>
                                            <div className="grid grid-cols-3 gap-2" role="group" aria-label="Select Gender">
                                                {genderOptions.map((g) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Icon size={18} className={isActive ? g.color : 'text-slate-500'} />
                                    ...
                                    {error && (
                                        <div className="flex items-center gap-3 text-red-400 text-[9px] font-black uppercase tracking-widest animate-reveal mt-2 bg-red-400/10 py-2.5 px-4 rounded-lg border border-red-400/20" role="alert">
                                            <AlertCircle size={12} />
                                            {error}
                                        </div>
                                    )}
                        ...
                        <div className="grid grid-cols-1 gap-3 pt-2">
                            ...
                            >
                                <div className="flex items-center justify-center gap-2 relative z-10 text-[10px] md:text-[11px]">
                                    <Video size={16} className="group-hover:rotate-12 transition-transform" aria-hidden="true" />
                                    <span>LAUNCH VIDEO CHAT</span>
                                    <ChevronRight className="group-hover:translate-x-1 transition-transform" size={14} aria-hidden="true" />
                                </div>
                            ...
                            <button
                                ...
                                className="group bg-slate-800/40 border border-white/10 p-4 rounded-xl font-black tracking-[0.2em] text-slate-300 hover:bg-slate-800/60 hover:text-white transition-all hover:scale-[1.01] active:scale-[0.99] text-[10px] md:text-[11px] backdrop-blur-sm"
                            >
                            ...
                            {initialMode === 'video' ? (
                                <div className="h-full w-full relative">
                                    ...
                                    <div className="absolute bottom-6 left-6 flex items-center gap-3 px-4 py-2 bg-black/60 backdrop-blur-2xl rounded-lg border border-white/10 shadow-2xl">
                                        ...
                                        <span className="text-[8px] font-black uppercase tracking-[0.2em] text-white">System: Camera Active</span>
                                    </div>
                                </div>
                            ) : (
                                <div className="h-full w-full flex flex-col items-center justify-center p-10 space-y-6 text-center relative">
                                    ...
                                    <div className="w-16 h-16 bg-blue-500/10 rounded-[1.5rem] flex items-center justify-center animate-bounce-slow border border-white/5 relative z-10 shadow-2xl">
                                        <Ghost size={32} className="text-blue-400/40" />
                                    </div>
                                    <div className="space-y-2 relative z-10">
                                        <h3 className="text-lg font-black text-white tracking-tight">Incognito Mode</h3>
                                        <p className="text-slate-400 text-[12px] leading-relaxed max-w-[200px] mx-auto font-medium">
                                            Ephemeral sessions. No logs, no tracking, just interactions.
                                        </p>
                                    </div>
                                    <div className="flex gap-3 opacity-30 relative z-10">
                                        <div className="p-2.5 bg-white/5 rounded-lg border border-white/10"><Globe size={16} /></div>
                                        <div className="p-2.5 bg-white/5 rounded-lg border border-white/10"><Shield size={16} /></div>
                                        <div className="p-2.5 bg-white/5 rounded-lg border border-white/10"><Zap size={16} /></div>
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                <section className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 opacity-50 animate-reveal" style={{ animationDelay: '0.3s' }} aria-label="Trust Badges">
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center gap-1.5 text-center group">
                            <badge.icon className={`${badge.color} group-hover:scale-110 transition-transform`} size={20} />
                            <span className="text-[7px] font-black uppercase tracking-[0.2em] text-slate-400">{badge.text}</span>
                        </div>
                    ))}
                </section>
            </div>
            ...
            <footer className="max-w-4xl w-full mt-10 pb-8 border-t border-white/5 pt-6 relative z-10 opacity-40 text-center px-6">
                <h2 className="text-[12px] font-black tracking-[0.3em] uppercase text-white mb-3">MaskMeet Protocol v5.0</h2>
                <p className="text-[8px] md:text-[9px] leading-relaxed max-w-xl mx-auto font-medium text-slate-400">
                    MaskMeet uses proprietary P2P technology. All communications are end-to-end encrypted.
                </p>
                <div className="mt-4 flex justify-center gap-5 text-[7px] font-bold uppercase tracking-widest text-slate-500">
