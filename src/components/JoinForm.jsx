                    ...
                    <div className="glass-panel p-8 md:p-12 rounded-[2.5rem] flex flex-col justify-between space-y-8 animate-reveal" style={{ animationDelay: '0.1s' }}>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div className="flex bg-black/40 border border-white/5 rounded-2xl p-1.5 gap-1.5">
                                            {[
                                                ...
                                                >
                                                    <User size={16} />
                                                    <span className="text-[9px] font-black uppercase tracking-tighter mt-1">{g.label}</span>
                                                </button>
                                            ))}
                                        </div>
                                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 pt-6">
                            ...
                            <button
                                ...
                                className="group bg-slate-800/40 border border-white/5 p-6 rounded-2xl font-black tracking-widest text-slate-400 hover:bg-slate-800 hover:text-white transition-all hover:scale-[1.02] active:scale-[0.98]"
                            >
